...
public interface IStyleRepository {
	...
	WorkbookStyleDefinitions getDefinitions(WorkbookId workbookId) throws StorageException, NetxiliaResourceException,
			NetxiliaBusinessException;

	void addDefinition(WorkbookId workbookId, StyleDefinition definition) throws StorageException,
