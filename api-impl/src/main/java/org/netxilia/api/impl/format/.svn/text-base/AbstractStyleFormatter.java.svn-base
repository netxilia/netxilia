...
public abstract class AbstractStyleFormatter implements IStyleFormatter {
	private final StyleDefinition definition;

	public AbstractStyleFormatter(StyleDefinition definition) {
		this.definition = definition;
	}

	@Override
	public StyleDefinition getDefinition() {
		return definition;
	}
