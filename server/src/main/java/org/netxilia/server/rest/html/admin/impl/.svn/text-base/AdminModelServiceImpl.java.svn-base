 ...
 ******************************************************************************/
package org.netxilia.server.rest.html.admin.impl;
...
public class AdminModelServiceImpl implements IAdminModelService {
	@Autowired
	...
	@Override
	public AdminInitModel buildInitModel() throws StorageException {
		return new AdminInitModel(dataSourceConfigurationService.findAll());
	}
