...
public interface ISheetModelService {
	public SheetModel buildModel(SheetFullName sheet, int start, Formula filter, boolean createSheetIfMissing)
			throws NotFoundException, StorageException, NetxiliaBusinessException;

	public SheetModel buildOverviewModel(SheetFullName sheetFullName) throws NotFoundException, StorageException,
			NetxiliaBusinessException;

	public SheetModel buildSummaryModel(SheetFullName summarySheetName, int columnCount, boolean createSheetIfMissing)
			throws NotFoundException, StorageException, NetxiliaBusinessException;
}
