...
/**
 * This is a basic implementation of a IColumnCommand
 * 
 * @author <a href='mailto:ax.craciun@gmail.com'>Alexandru Craciun</a>
 * 
 */
public abstract class AbstractColumnCommand implements IColumnCommand {
	private final Range target;
	private final boolean toInsert;

	public AbstractColumnCommand(Range target) {
		this(target, false);
	}

	public AbstractColumnCommand(Range target, boolean toInsert) {
		this.target = target;
