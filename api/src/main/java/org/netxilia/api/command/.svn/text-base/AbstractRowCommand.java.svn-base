...
/**
 * This is a basic implementation of a IRowCommand
 * 
 * @author <a href='mailto:ax.craciun@gmail.com'>Alexandru Craciun</a>
 * 
 */
public abstract class AbstractRowCommand implements IRowCommand {
	private final Range target;
	private final boolean toInsert;

	public AbstractRowCommand(Range target) {
		this(target, false);
	}

	public AbstractRowCommand(Range target, boolean toInsert) {
		this.target = target;
