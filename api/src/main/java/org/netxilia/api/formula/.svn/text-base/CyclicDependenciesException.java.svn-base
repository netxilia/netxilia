...
/**
 * This exception is thrown when setting formula to a cell, it will end up in a cyclic dependency.
 * 
 * @author <a href='mailto:ax.craciun@gmail.com'>Alexandru Craciun</a>
 * 
 */
public class CyclicDependenciesException extends NetxiliaBusinessException {
